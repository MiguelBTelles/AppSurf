...
export default function AddStudent() {
    ...
    return (
        <ContainerComponent>
            <ScrollComponent>
                <ContentComponent>
                    <HeaderComponent onBack={() => { router.navigate('/(app)/(tabs)/profile/my-students') }} />
                    ...
                    <View style={{marginTop: 40}}>
                        <ButtonComponent text="ADICIONAR" onPress={()=> {router.navigate("/(app)/(tabs)/profile/my-students")}}/>
                    </View>
                </ContentComponent>
            </ScrollComponent>
        </ContainerComponent>
